...
const services = [
  {
    icon: <Monitor className="w-12 h-12 text-[#d4a7c6]" />,
    title: "Web Design",
    description:
      "Create beautiful, responsive websites that engage your audience and drive results.",
  },
  {
    icon: <Palette className="w-12 h-12 text-[#d4a7c6]" />,
    title: "Branding",
    description:
      "Build a strong brand identity that sets you apart from the competition.",
  },
  {
    icon: <Megaphone className="w-12 h-12 text-[#d4a7c6]" />,
    title: "Digital Marketing",
    description:
      "Reach your target audience and grow your business with strategic digital marketing.",
  },
  {
    icon: <Code className="w-12 h-12 text-[#d4a7c6]" />,
    title: "Development",
    description:
...
const Services = () => {
  ...
  return (
    <section id="services" className="py-20 bg-[#0c0718] text-[#ffffff]">
      <div className="container mx-auto px-4">
        <div className="text-center mb-16">
          <h2 className="text-4xl font-bold mb-4">Our Services</h2>
          <p className="text-xl text-[#c29acf]">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          {services.map((service, index) => (
            <motion.div
              ...
              whileInView={{ opacity: 1, y: 0 }}
              transition={{ duration: 0.5, delay: index * 0.1 }}
              className={`p-6 bg-[#5c3c6d] rounded-lg cursor-pointer ${
                selectedService === index
